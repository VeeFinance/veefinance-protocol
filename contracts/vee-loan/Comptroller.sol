...
contract Comptroller is ComptrollerV5Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function _supportMarket(CToken cToken) external returns (uint) {
        ...
        // Note that isVeeed is not in active use anymore
        /**
        bool isListed;
     ...
     /**
      * @notice Sets VEE token addres
      * @dev Admin function to set token addres
      * @param veeAddr New vee token address
      * @return uint 0=success, otherwise a failure. (See ErrorReporter for details)
      */
    ...
    /**
     * @notice Set VEE speed for a single market
     * @param cToken The market whose VEE speed to update
     * @param veeSpeed New VEE speed for market
     */
    function setVeeSpeedInternal(CToken cToken, uint veeSpeed) internal {
        ...
        if (currentVeeSpeed != 0) {
            // note that VEE speed could be set to 0 to halt liquidity rewards for a market
    ...
    /**
     * @notice Accrue VEE to the market by updating the supply index
    ...
    /**
     * @notice Accrue VEE to the market by updating the borrow index
    ...
    /**
     * @notice Calculate VEE accrued by a supplier and possibly transfer it to them
     * @param cToken The market in which the supplier is interacting
     * @param supplier The address of the supplier to distribute VEE to
     */
    ...
    /**
     * @notice Calculate VEE accrued by a borrower and possibly transfer it to them
     * @dev Borrowers will not begin to accrue until after the first interaction with the protocol.
     * @param cToken The market in which the borrower is interacting
     * @param borrower The address of the borrower to distribute VEE to
     */
    ...
    /**
     * @notice Calculate additional accrued VEE for a contributor since last accrual
    ...
    /**
     * @notice Claim all the vee accrued by holder in all markets
     * @param holder The address to claim VEE for
     */
    ...
    /**
     * @notice Claim all the vee accrued by holder in the specified markets
     * @param holder The address to claim VEE for
     * @param cTokens The list of markets to claim VEE in
     */
    ...
    /**
     * @notice Claim all vee accrued by the holders
     * @param holders The addresses to claim VEE for
     * @param cTokens The list of markets to claim VEE in
     * @param borrowers Whether or not to claim VEE earned by borrowing
     * @param suppliers Whether or not to claim VEE earned by supplying
     */
    ...
    /**
     * @notice Transfer VEE to the user
     * @dev Note: If there is not enough VEE , we do not perform the transfer all.
     * @param user The address of the user to transfer VEE to
     * @param amount The amount of VEE to (possibly) transfer
     * @return The amount of VEE which was NOT transferred to the user
     */
    ...
    /*** Vee Distribution Admin ***/

    /**
     * @notice Transfer VEE to the recipient
     * @dev Note: If there is not enough VEE , we do not perform the transfer all.
     * @param recipient The address of the recipient to transfer VEE to
     * @param amount The amount of VEE to (possibly) transfer
     */
    ...
    /**
     * @notice Set VEE speed for a single contributor
     * @param contributor The contributor whose VEE speed to update
     * @param veeSpeed New VEE speed for contributor
     */
    function _setContributorVeeSpeed(address contributor, uint veeSpeed) public {
        require(adminOrInitializing(), "only admin can set vee speed");

        // note that VEE speed could be set to 0 to halt liquidity rewards for a contributor
    ...
    /**
     * @notice Return the address of the VEE token
     * @return The address of VEE
     */
